...
import { AssistantStreamAccumulator } from '@x1a0f3n9/dsh-llm/assistant-stream'
import type { StreamChunk } from '@x1a0f3n9/dsh-llm'
import type { SessionEvent } from '@x1a0f3n9/dsh-session/types'
import type { ChatSnapshot } from '@x1a0f3n9/dsh-client-ui-chat/client'
...
assertBuiltBenchmarkRuntime(import.meta.url, {
  '@x1a0f3n9/dsh-client-store': import.meta.resolve('@x1a0f3n9/dsh-client-store'),
  '@x1a0f3n9/dsh-llm/assistant-stream': import.meta.resolve('@x1a0f3n9/dsh-llm/assistant-stream'),
  '@x1a0f3n9/dsh-session/surface': import.meta.resolve('@x1a0f3n9/dsh-session/surface'),
  '@x1a0f3n9/dsh-token-meter/client': import.meta.resolve('@x1a0f3n9/dsh-token-meter/client'),
})
