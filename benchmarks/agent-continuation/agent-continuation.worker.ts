...
import { createUserMessage, LlmAdapter } from '@x1a0f3n9/dsh-llm'
...
assertBuiltBenchmarkRuntime(import.meta.url, Object.fromEntries([
  '@x1a0f3n9/dsh-agent-loop', '@x1a0f3n9/dsh-session', '@x1a0f3n9/dsh-llm',
  '@x1a0f3n9/dsh-tools', '@x1a0f3n9/dsh-session-persistence-jsonl',
