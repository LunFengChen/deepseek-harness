...
- `packages/*` (except agent-loop's own tests and examples/) must not import `@x1a0f3n9/dsh-agent-loop`.
- No cross-package deep imports (`@x1a0f3n9/dsh-*/src/...` paths) — public entry points only.
