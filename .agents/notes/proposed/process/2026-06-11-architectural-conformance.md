...
- `packages/*` (except agent-loop's own tests and examples/) must not import `@xfcodeai/dsh-agent-loop`.
- No cross-package deep imports (`@xfcodeai/dsh-*/src/...` paths) — public entry points only.
