...
- **`@x1a0f3n9/dsh` is installable by consumers outside the organization.** Its dsh manifests are public, and its vendored and native dependencies are public under their separate `@deepseek-ai` release sequences.
