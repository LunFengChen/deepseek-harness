 ...
 * repository.
 * @module @x1a0f3n9/dsh-client-test-runtime/src/assembly/bundle-roster
 */
...
import { exactPackageSpecifier, parseDshClient } from '@x1a0f3n9/dsh-client-modules/client'
...
export const WEB_PROFILE_BUNDLES: readonly string[] = ['@x1a0f3n9/dsh-base', '@x1a0f3n9/dsh-web-app']
