...
import { parseBootManifest } from '@x1a0f3n9/dsh-client-modules/client'
import type { WebBootGraph } from '@x1a0f3n9/dsh-client-modules/client'
import * as uiRenderer from '@x1a0f3n9/dsh-client-ui-renderer/client'
import * as typertRegistry from '@x1a0f3n9/dsh-typert-registry/client'
...
const RENDERER = '@x1a0f3n9/dsh-client-ui-renderer'
const TYPERT = '@x1a0f3n9/dsh-typert-registry'
const BRAND = '@x1a0f3n9/dsh-client-ui-brand-official'
const MISSING = '@x1a0f3n9/dsh-client-does-not-exist'
...
describe('createInProcessModules', () => {
  it('serves import() and prefetch() from registered factories and never loads a bundle', async () => {
    ...
    await expect(system.import('@x1a0f3n9/dsh-client-unknown', '', {})).rejects.toThrow('cannot resolve')
  })
