...
const HMR = '@x1a0f3n9/dsh-client-hmr'
const MODULES = '@x1a0f3n9/dsh-client-modules'
const SESSIONS = '@x1a0f3n9/dsh-api-session-controller'
const FILE_UPLOAD = '@x1a0f3n9/dsh-client-file-upload'
