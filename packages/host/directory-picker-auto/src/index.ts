 ...
 * @module @xfcodeai/dsh-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@xfcodeai/dsh-host-directory-picker-native',
  browse: '@xfcodeai/dsh-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@xfcodeai/dsh-client-ui-directory-picker-native',
  browse: '@xfcodeai/dsh-client-ui-directory-picker-browse',
}
