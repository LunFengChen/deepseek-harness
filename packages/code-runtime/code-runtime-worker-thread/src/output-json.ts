/** JSON string-prefix accounting for the outer-output ledger. @module @xfcodeai/dsh-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@xfcodeai/dsh-code-runtime'
