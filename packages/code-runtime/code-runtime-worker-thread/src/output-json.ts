/** JSON string-prefix accounting for the outer-output ledger. @module @x1a0f3n9/dsh-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@x1a0f3n9/dsh-code-runtime'
