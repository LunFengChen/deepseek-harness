 ...
 * @module @xfcodeai/dsh-message-feedback
 */
...
import { deriveEventMessage, isAppendSurfaceEvent } from '@xfcodeai/dsh-session/surface'
import type { SessionHeader, SessionId } from '@xfcodeai/dsh-session/types'
