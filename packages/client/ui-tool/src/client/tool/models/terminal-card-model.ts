...
import type { TerminalBlockLabels, TerminalBlockProps } from '@xfcodeai/dsh-client-ui-primitives'
...
/**
 * Parse the marker literals owned by `@xfcodeai/dsh-shell/render` without
