...
import { createScope } from '@xfcodeai/dsh-api-session-controller/client'
...
import type { ModelSelection, ModelSelectionProjection } from '@xfcodeai/dsh-api-session-controller/types'
import type { CommandContribution, SelectOption } from '@xfcodeai/dsh-client-ui-commands/client'
