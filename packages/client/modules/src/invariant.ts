/**
 * Package-owned invariant companion for `@xfcodeai/dsh-client-modules`.
 * @module @xfcodeai/dsh-client-modules/invariant
 */
...
const PACKAGE_NAME = '@xfcodeai/dsh-client-modules'
