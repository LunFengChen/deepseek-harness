...
import type { GoalSnapshot } from '@x1a0f3n9/dsh-goal/client'
import {
...
export type GoalDockProps = import('@x1a0f3n9/dsh-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
