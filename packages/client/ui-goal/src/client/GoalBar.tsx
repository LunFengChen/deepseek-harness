...
import type { GoalSnapshot } from '@xfcodeai/dsh-goal/client'
import {
...
export type GoalDockProps = import('@xfcodeai/dsh-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
