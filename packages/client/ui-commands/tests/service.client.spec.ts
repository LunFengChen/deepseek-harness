...
import type { CommandResult } from '@xfcodeai/dsh-commands/types'
...
import type { ClientSessionContext, ConsumeTokenRequest, InputTriggerPick, InputTriggerSource, SubmitImageAttachment } from '@xfcodeai/dsh-client-ui-input-trigger/client'
