...
export const en = {
  ...
  retryPolicy: 'Retry',
  retryPolicyNone: 'Default',
  retryPolicyCustom: 'Custom count and delay',
  retryMaxRetries: 'Retry count',
  retryInitialDelay: 'Initial delay (ms)',
  retryCountInvalid: 'Retry count must be a whole number 0 or greater.',
  retryDelayInvalid: 'Initial delay must be a positive number of milliseconds.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  retryPolicy: '重试',
  retryPolicyNone: '默认',
  retryPolicyCustom: '自定义次数和间隔',
  retryMaxRetries: '重试次数',
  retryInitialDelay: '初始间隔（毫秒）',
  retryCountInvalid: '重试次数必须是 0 或更大的整数。',
  retryDelayInvalid: '初始间隔必须是正的毫秒数。',
