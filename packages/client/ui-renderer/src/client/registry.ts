...
import { SlotCore, standardHookPropName } from '@xfcodeai/dsh-client-ui-slots'
import type {
...
export class SlotRegistry extends Service {
  ...
  private rebuildRootBinding(): void {
    ...
    const keyedHooks: Record<string, import('@xfcodeai/dsh-client-ui-slots').KeyedStandardSource> = {}
