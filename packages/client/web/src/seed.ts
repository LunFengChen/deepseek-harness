...
import * as ClientStore from '@xfcodeai/dsh-client-store'
import * as UiSlots from '@xfcodeai/dsh-client-ui-slots'
import * as UiPrimitives from '@xfcodeai/dsh-client-ui-primitives'
...
export function getStaticModules(): Record<string, unknown> {
  ...
  return {
    ...
    '@xfcodeai/dsh-client-store': ClientStore,
    '@xfcodeai/dsh-client-ui-slots': UiSlots,
    '@xfcodeai/dsh-client-ui-primitives': UiPrimitives,
