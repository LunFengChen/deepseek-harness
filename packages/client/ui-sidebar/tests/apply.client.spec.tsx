...
import { apply, inject } from '@x1a0f3n9/dsh-client-ui-sidebar/client'
import type { SidebarRootInjected } from '@x1a0f3n9/dsh-client-ui-sidebar/client'
...
describe('ui-sidebar apply', () => {
  ...
  it('registers the shell and declares its child seats', async () => {
    ...
    expect(b.slots.spec('sidebar.newSession.action')).toEqual({ kind: 'list', scope: 'root' })
  ...
  it('removes the entry and child declaration on teardown', async () => {
    ...
    expect(b.slots.spec('sidebar.newSession.action')).toBeUndefined()
