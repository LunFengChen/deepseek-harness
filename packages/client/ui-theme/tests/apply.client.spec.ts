...
import { apply, inject, SETTINGS_NS } from '@xfcodeai/dsh-client-ui-theme/client'
import type { AppearanceRowInjected, FontSizeRowInjected, ThemeRuntime } from '@xfcodeai/dsh-client-ui-theme/client'
