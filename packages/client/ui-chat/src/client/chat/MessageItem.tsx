...
import { JsonBlock, projectUserText, StateDot } from '@x1a0f3n9/dsh-client-ui-primitives'
...
export const UserMessageNodeView = memo(function UserMessageNodeView({
  node, renderMessageImages, deleteFrom, regenerate, t,
    ...
    <UserStyleBubble
      ...
      actions={text => (
        <MessageIconActions
          ...
          clock="start"
          className={css.actions}
          onRegenerate={() => { regenerate(node.anchorSeq, data.content) }}
