...
export const zh = {
  ...
  'message.regenerate': '重新生成回答',
  'message.regenerate.title': '确认重新生成回答',
  'message.regenerate.description': '将永久删除当前消息及其后的历史，然后重新提交这个问题。',
  'message.regenerate.confirm': '重新生成',
  'message.delete': '删除此处及后续记录',
  'message.delete.title': '确认删除会话历史',
  'message.delete.description': '将永久删除当前消息以及后面的所有消息，且无法恢复。',
  'message.delete.acknowledge': '我确认永久删除',
  'message.delete.cancel': '取消',
  'message.delete.close': '关闭确认框',
...
export const en = {
  ...
  'message.regenerate': 'Regenerate answer',
  'message.regenerate.title': 'Regenerate this answer?',
  'message.regenerate.description': 'This permanently deletes this message and later history, then submits the same question again.',
  'message.regenerate.confirm': 'Regenerate',
  'message.delete': 'Delete from here',
  'message.delete.title': 'Delete session history?',
  'message.delete.description': 'This permanently deletes this message and all later history. It cannot be undone.',
  'message.delete.acknowledge': 'I understand this is permanent',
  'message.delete.cancel': 'Cancel',
  'message.delete.close': 'Close confirmation',
  'message.delete.confirm': 'Delete permanently',
