 ...
 *
 * @module @xfcodeai/dsh-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@xfcodeai/dsh-shell'
import type { SandboxMode } from '@xfcodeai/dsh-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@xfcodeai/dsh-sandbox'
 ...
 * rendering story, owned by `@xfcodeai/dsh-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@xfcodeai/dsh-shell'
