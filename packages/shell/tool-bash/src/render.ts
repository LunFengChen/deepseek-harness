 ...
 *
 * @module @x1a0f3n9/dsh-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@x1a0f3n9/dsh-shell'
import type { SandboxMode } from '@x1a0f3n9/dsh-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@x1a0f3n9/dsh-sandbox'
 ...
 * rendering story, owned by `@x1a0f3n9/dsh-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@x1a0f3n9/dsh-shell'
