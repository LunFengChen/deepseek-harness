/** Package-owned durable retry-event invariants. @module @x1a0f3n9/dsh-llm-retry/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { Session, SessionEvent } from '@x1a0f3n9/dsh-session'
import type { LlmFailure } from '@x1a0f3n9/dsh-llm'
...
const PACKAGE_NAME = '@x1a0f3n9/dsh-llm-retry'
