/** Package-owned durable retry-event invariants. @module @xfcodeai/dsh-llm-retry/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { Session, SessionEvent } from '@xfcodeai/dsh-session'
import type { LlmFailure } from '@xfcodeai/dsh-llm'
...
const PACKAGE_NAME = '@xfcodeai/dsh-llm-retry'
