...
import type { AuthorizationMethod, AuthorizationPrompt, AuthorizationSession } from '@x1a0f3n9/dsh-authorization'
import { isCredentialKeySegment } from '@x1a0f3n9/dsh-credentials'
