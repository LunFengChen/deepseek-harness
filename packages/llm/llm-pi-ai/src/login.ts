...
import type { AuthorizationMethod, AuthorizationPrompt, AuthorizationSession } from '@xfcodeai/dsh-authorization'
import { isCredentialKeySegment } from '@xfcodeai/dsh-credentials'
