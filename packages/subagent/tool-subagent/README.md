...
```yaml
- name: '@xfcodeai/dsh-subagent'
- name: '@xfcodeai/dsh-subagent-spawn-in-process'
- name: '@xfcodeai/dsh-tool-subagent'
  config:
    provider: spawn
    toolName: subagent
```
...
The generated [configuration catalog](../../../docs/config-catalog.md#xfcodeaidsh-tool-subagent) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#xfcodeaidsh-tool-subagent) — the default schema and per-mode wording.
- [Generated configuration catalog](../../../docs/config-catalog.md#xfcodeaidsh-tool-subagent) — every accepted config field.
