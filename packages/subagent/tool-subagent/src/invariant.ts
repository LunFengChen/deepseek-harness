/**
 * Package-owned invariant companion for `@xfcodeai/dsh-tool-subagent`.
 * @module @xfcodeai/dsh-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@xfcodeai/dsh-tool-subagent'
