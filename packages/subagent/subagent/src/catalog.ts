 ...
 *
 * @module @x1a0f3n9/dsh-subagent/catalog
 */

import { z } from 'zod'
import { appendChunkedList, chunkedListSchema, iterateChunkedList } from '@x1a0f3n9/dsh-chunked-list'
import type { ChunkedList } from '@x1a0f3n9/dsh-chunked-list'
import type {
  Session,
  SessionEvent,
  SessionHeader,
