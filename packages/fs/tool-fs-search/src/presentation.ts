 ...
 * model-facing render consumes ({@link module:@xfcodeai/dsh-tool-fs-search/search-core}
 ...
 *
 * @module @xfcodeai/dsh-tool-fs-search/presentation
 */
 ...
 * ({@link module:@xfcodeai/dsh-tool-fs-search/grep} `formatGrepMatches`), so
