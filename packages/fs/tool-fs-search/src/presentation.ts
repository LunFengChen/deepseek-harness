 ...
 * model-facing render consumes ({@link module:@x1a0f3n9/dsh-tool-fs-search/search-core}
 ...
 *
 * @module @x1a0f3n9/dsh-tool-fs-search/presentation
 */
 ...
 * ({@link module:@x1a0f3n9/dsh-tool-fs-search/grep} `formatGrepMatches`), so
