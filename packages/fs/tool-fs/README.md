...
The generated [configuration catalog](../../../docs/config-catalog.md#xfcodeaidsh-tool-fs) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#xfcodeaidsh-tool-fs) — the exhaustive schemas this package registers.
