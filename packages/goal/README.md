...
- [Generated tool catalog](../../docs/tool-catalog.md#xfcodeaidsh-tool-goal) — the three goal-tool schemas the model receives.
- [Generated configuration catalog](../../docs/config-catalog.md#xfcodeaidsh-goal) — every accepted config field of the goal service.
