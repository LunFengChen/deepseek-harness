...
import * as GoalSessionInvariant from '@x1a0f3n9/dsh-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@x1a0f3n9/dsh-goal-round-driver'
import InvariantRegistry, { InvariantError } from '@x1a0f3n9/dsh-invariants'
import SessionStore, { SessionId, type Session } from '@x1a0f3n9/dsh-session'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@x1a0f3n9/dsh-goal-round-driver',
    }))
  })
