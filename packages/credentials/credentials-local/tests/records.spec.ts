...
import { credentialKey, credentialKeyScope, credentialRef, parseCredentialKey } from '@xfcodeai/dsh-credentials'
import type { CredentialKey, CredentialRecord } from '@xfcodeai/dsh-credentials'
