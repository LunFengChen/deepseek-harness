...
```yaml
- name: '@xfcodeai/dsh-skill'
- name: '@xfcodeai/dsh-skill-filesystem'
- name: '@xfcodeai/dsh-tool-skill'
```
...
The generated [configuration catalog](../../../docs/config-catalog.md#xfcodeaidsh-tool-skill) is the exhaustive source for every accepted field.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#xfcodeaidsh-tool-skill) — the exact `skill` schema the model receives.
...
The model sees the generated [`skill` schema](../../../docs/tool-catalog.md#xfcodeaidsh-tool-skill).
