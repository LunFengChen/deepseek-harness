...
import type { GenericCallView, ToolResult, WebFetchResultView } from '@xfcodeai/dsh-tools'
import type { WebFetchBody, WebFetchResult } from '@xfcodeai/dsh-web'
import { assertNever, type JsonValue } from '@xfcodeai/dsh-util-values'
 ...
 * `@xfcodeai/dsh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@xfcodeai/dsh-tool-call-timeout-policy` to enforce.
