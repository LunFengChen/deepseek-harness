...
import type { GenericCallView, ToolResult, WebFetchResultView } from '@x1a0f3n9/dsh-tools'
import type { WebFetchBody, WebFetchResult } from '@x1a0f3n9/dsh-web'
import { assertNever, type JsonValue } from '@x1a0f3n9/dsh-util-values'
 ...
 * `@x1a0f3n9/dsh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@x1a0f3n9/dsh-tool-call-timeout-policy` to enforce.
