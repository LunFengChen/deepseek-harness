...
} from '@x1a0f3n9/dsh-sandbox-local'
import type { Config } from '@x1a0f3n9/dsh-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @x1a0f3n9/dsh-sandbox-windows-acl/tests/provider-chain.spec.ts
