...
} from '@xfcodeai/dsh-sandbox-local'
import type { Config } from '@xfcodeai/dsh-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @xfcodeai/dsh-sandbox-windows-acl/tests/provider-chain.spec.ts
