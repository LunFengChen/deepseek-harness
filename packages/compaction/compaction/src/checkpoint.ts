 ...
 *
 * The seam itself lives in `@xfcodeai/dsh-compaction`, which re-exports these
 ...
 *
 * @module @xfcodeai/dsh-compaction/checkpoint
 */

import type { MessageSource } from '@xfcodeai/dsh-llm/message'
