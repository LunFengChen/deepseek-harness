...
import { spawn, spawnSync } from '@x1a0f3n9/dsh-experimental-webworker-runtime/src/node/builtin_modules/implemented/child_process.ts'
import {
  LAUNCHER_FAILURE_EXIT, grantArgs, launcherPath, probe,
} from '@deepseek-ai/node-addon-landlock-run'
import { processAlive, signalProcess } from '@x1a0f3n9/dsh-experimental-webworker-runtime/src/node/process-table.ts'
import { hostFileSystem } from '@x1a0f3n9/dsh-experimental-webworker-runtime/src/shell/fs-access.ts'
import {
  LANDLOCK_EXECUTABLE, landlockFileSystem, parseLandlockArguments,
} from '@x1a0f3n9/dsh-experimental-webworker-runtime/src/shell/process/landlock.ts'
import { spawnSubprocess } from '@x1a0f3n9/dsh-subprocess-local/src/spawn.ts'

vi.mock('node:child_process', async () =>
  await import('@x1a0f3n9/dsh-experimental-webworker-runtime/src/node/builtin_modules/implemented/child_process.ts'))
