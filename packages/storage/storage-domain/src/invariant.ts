/**
 * Package-owned invariant companion for `@x1a0f3n9/dsh-storage-domain`: every
 ...
 * @module @x1a0f3n9/dsh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@x1a0f3n9/dsh-storage-domain'
