/**
 * Package-owned invariant companion for `@xfcodeai/dsh-storage-domain`: every
 ...
 * @module @xfcodeai/dsh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@xfcodeai/dsh-storage-domain'
