...
- [生成的工具目录](../../docs/tool-catalog.zh.md#xfcodeaidsh-tool-cordis)——七个模型侧工具 schema。
- [生成的配置目录](../../docs/config-catalog.zh.md#xfcodeaidsh-cordis-host-runner)——runner 的受支持配置字段。
