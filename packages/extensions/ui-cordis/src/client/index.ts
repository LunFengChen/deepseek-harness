...
import type {} from '@xfcodeai/dsh-client-ui-tool/client'
...
import type { InputTriggerService, InputTriggerSource } from '@xfcodeai/dsh-client-ui-input-trigger/client'
