...
import { HOST_BUILTIN_INSPECTION } from '@xfcodeai/dsh-cordis-host-runner'
import type { HostCordisInspectProviderRegistration } from '@xfcodeai/dsh-cordis-host-runner'
