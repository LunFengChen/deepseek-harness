...
- [Generated tool catalog](../../../docs/tool-catalog.md#xfcodeaidsh-tool-cordis) — the exact schemas the model receives.
...
The conversation model sees the generated [`cordis_inspect_list`, `cordis_inspect_query`, `cordis_inspect_self`, `cordis_define`, `cordis_run`, `cordis_stop`, and `cordis_undefine` schemas](../../../docs/tool-catalog.md#xfcodeaidsh-tool-cordis) whenever this plugin is visible.
