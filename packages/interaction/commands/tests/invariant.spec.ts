...
import * as CommandInvariant from '@x1a0f3n9/dsh-commands/invariant'
import InvariantRegistry, { InvariantError } from '@x1a0f3n9/dsh-invariants'
import SessionStore, { SessionId, SessionSeq, type Session } from '@x1a0f3n9/dsh-session'
import { CommandId } from '@x1a0f3n9/dsh-commands'
...
describe('command lifecycle invariants', () => {
  ...
  it.each([-1, 1.5, 1])('rejects invalid or non-prior sourceEventSeq %s', async (sourceEventSeq) => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@x1a0f3n9/dsh-commands',
    }))
  })
