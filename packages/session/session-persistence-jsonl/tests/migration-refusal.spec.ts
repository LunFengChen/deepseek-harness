...
import type { SessionFormatJsonObject } from '@x1a0f3n9/dsh-session-format'
...
const nativePrefix: readonly SessionFormatJsonObject[] = [
  ...
  { type: 'system/message', surfaceOp: 'append', data: {
    turn: 1, step: 1, message: {
      id: 'native-system', role: 'system', source: { kind: 'plugin', plugin: '@x1a0f3n9/dsh-system-prompt' },
...
const migrationRefusals = [
  ...
  }))),
  {
    ...
    diagnostic: '@x1a0f3n9/dsh-session-format-v2-to-v3 refuses this format v2 Session: format v2 delivery marker claims target format v3',
  },
  {
