 ...
 *
 * @module @x1a0f3n9/dsh-session-persistence/tests/contract
 */

import { describe, expect, it } from 'vitest'
import { SessionSeq, SESSION_FORMAT_VERSION, SessionId } from '@x1a0f3n9/dsh-session'
import type { SessionEvent, SessionHeader } from '@x1a0f3n9/dsh-session'
import { MessageId, freezeMessage } from '@x1a0f3n9/dsh-llm'
import {
