/**
 * Package-owned invariant companion for `@xfcodeai/dsh-session-title`.
 * @module @xfcodeai/dsh-session-title/invariant
 */
...
const PACKAGE_NAME = '@xfcodeai/dsh-session-title'
