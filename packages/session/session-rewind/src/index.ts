...
import { SessionSeq, type AssistantMessage, type Session, type SessionEvent } from '@x1a0f3n9/dsh-session'
    ...
    try {
      ...
      try {
        event = agent.session.append('assistant/message', { turn, step, message: marker }, {
          surfaceOp: {
            op: 'replace',
            start: SessionSeq(plan.surfaceStart),
            end: SessionSeq(plan.surfaceEnd),
          },
