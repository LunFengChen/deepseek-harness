...
import { agentPresetProjectionDefinition } from '@xfcodeai/dsh-agent-presets'
...
import SessionProjectionCache, { projectionCacheDomainSpec } from '@xfcodeai/dsh-session-projection-cache'
...
import type { SessionControlFrame, SessionFollowFrame } from '@xfcodeai/dsh-api-session-controller/types'
