...
- id: delegation
  ...
  config:
    - id: workflow-worker-thread
      name: '@xfcodeai/dsh-workflow-worker-thread'
      config:
        provider: spawn
    - id: tool-workflow
      name: '@xfcodeai/dsh-tool-workflow'
```
