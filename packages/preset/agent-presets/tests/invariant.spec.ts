...
import AgentRegistry, { assembleContextFor } from '@xfcodeai/dsh-agent'
import AgentLoop from '@xfcodeai/dsh-agent-loop'
import InvariantRegistry from '@xfcodeai/dsh-invariants'
import { describe, expect, it } from 'vitest'
import AgentPresets, { livePresetMounts, type Config } from '@xfcodeai/dsh-agent-presets'
import * as AgentPresetsInvariant from '@xfcodeai/dsh-agent-presets/invariant'
