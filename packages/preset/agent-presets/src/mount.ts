 ...
 * @module @x1a0f3n9/dsh-agent-presets/mount
 */
...
import { scopeOf, scopeParentOf, type ScopeKey } from '@x1a0f3n9/dsh-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@x1a0f3n9/dsh-*` row would fail to import. The
