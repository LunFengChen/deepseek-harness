 ...
 * @module @xfcodeai/dsh-agent-presets/mount
 */
...
import { scopeOf, scopeParentOf, type ScopeKey } from '@xfcodeai/dsh-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@xfcodeai/dsh-*` row would fail to import. The
