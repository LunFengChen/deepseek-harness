...
import { bindScopeParent, createScope } from '@xfcodeai/dsh-scope'
...
import type { PreToolDecision, ToolDefinition, ToolExecution, ToolExecutionInput, ToolExecutionToken } from '@xfcodeai/dsh-tools'
