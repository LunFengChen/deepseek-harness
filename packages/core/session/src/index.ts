...
import { scopeOf, scopeTarget } from '@xfcodeai/dsh-scope'
...
import type { TypertLookup } from '@xfcodeai/dsh-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@xfcodeai/dsh-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@xfcodeai/dsh-session#Session',
