 ...
 * @module @xfcodeai/dsh-agent-loop/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@xfcodeai/dsh-llm'
import type { InvariantFailure, InvariantInstaller } from '@xfcodeai/dsh-invariants'
import { foldRequestHeader } from '@xfcodeai/dsh-session'

const PACKAGE_NAME = '@xfcodeai/dsh-agent-loop'
