...
- [Generated configuration catalog](../../../docs/config-catalog.md#xfcodeaidsh-agent-default-model) — every accepted config field and its source declaration.
