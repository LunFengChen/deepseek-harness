...
The generated [configuration catalog](../../../docs/config-catalog.md#xfcodeaidsh-tool-workflow) is the exhaustive source for every accepted field.
...
When visible, the generated default [`workflow` schema](../../../docs/tool-catalog.md#xfcodeaidsh-tool-workflow) carries the complete JavaScript hook and metadata contract; `toolName` can rename the definition, and the model submits script, metadata, and optional args.
