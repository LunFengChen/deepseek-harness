...
import type { SubagentCapabilities, SubagentProvider, SubagentRun, SubagentStartRequest } from '@xfcodeai/dsh-subagent'
...
import type { WorkflowResult, WorkflowRun, WorkflowStartRequest } from '@xfcodeai/dsh-workflow'
