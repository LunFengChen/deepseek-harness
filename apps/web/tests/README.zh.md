...
`@xfcodeai/dsh-client-web` import `AppWebEntry`、从
`@xfcodeai/dsh-client-modules/client` import boot manifest 类型：启动真实 shell 正是该
