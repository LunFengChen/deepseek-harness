...
import { bootInjections, orderByModuleGraph } from '@xfcodeai/dsh-client-modules'
import type { ClientModuleLoaderTarget, WebBootEntry, WebBootGraph } from '@xfcodeai/dsh-client-modules/client'
...
const appBoot = await import(pathToFileURL(webBundleResolver.resolve('@xfcodeai/dsh-app-boot')).href) as unknown as BootComposition
...
const BOOTSTRAP_IDS = ['@xfcodeai/dsh-client-modules'] as const
