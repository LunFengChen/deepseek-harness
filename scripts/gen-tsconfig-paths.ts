 ...
 * `@xfcodeai/dsh-*` listed 49 candidate globs and `@xfcodeai/dsh-*\/invariant`
 ...
 * @returns Every directory whose manifest names a `@xfcodeai/dsh-` package and that carries `src`.
 */
 ...
 * `@xfcodeai/dsh-<directory>`. Packages named after something other than
 ...
 *
 * @returns Declared names of every `@xfcodeai/dsh-` package carrying a `src` directory.
 */
