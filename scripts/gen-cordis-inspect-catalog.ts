...
import type { CordisCatalogModel, ServiceMethodEntry } from '@xfcodeai/dsh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    ...
    .replaceAll('@xfcodeai/dsh-tool-cordis/api-catalog', '@xfcodeai/dsh-cordis-client-runner/client/api-catalog')
