...
import type { CordisCatalogModel, ServiceMethodEntry } from '@x1a0f3n9/dsh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    ...
    .replaceAll('@x1a0f3n9/dsh-tool-cordis/api-catalog', '@x1a0f3n9/dsh-cordis-client-runner/client/api-catalog')
