...
| Better sidebar | Preinstalled, disableable plugin `github:LunFengChen/DSH-better-sidebar#v0.19.2` (`@x1a0f3n9/dsh-better-sidebar`). | Files, terminal, Git, and subagents live in the sidebar workbench. |
