...
| Hindsight git stderr | pnpm patch pipes `git` stderr in `@vectorize-io/hindsight-coding-agents@0.5.2`. | Opening a session whose cwd is not a git repository no longer prints `fatal: not a git repository`. |
