...
| Hindsight memory | Preinstalled and off by default: `@vectorize-io/hindsight-coding-agents@0.5.2`. | Enable it from Settings → Plugins after a Hindsight Cloud account or local server is configured in `~/.hindsight/coding-agent.json`. |
